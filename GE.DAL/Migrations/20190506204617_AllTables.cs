        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Earned = table.Column<int>(nullable: true),
                    Spent = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Operations_Points_PointId",
                        column: x => x.PointId,
                        principalTable: "Points",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreatePost = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImagesGalleries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImagesGalleries_Posts_PostId",
                        column: x => x.PostId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImagesGalleries_PostId",
                table: "ImagesGalleries",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_Operations_PointId",
                table: "Operations",
                column: "PointId");
